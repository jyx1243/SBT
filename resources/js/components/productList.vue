<template>
  <div class="border-top pt-3 mt-3">
    <div class="d-flex">
      <router-link
        :to="{ name: 'product.show', params: { optionId: option.id } }"
      >
        <img class="img-product-index" :src="'/img/product/' + option.image" />
      </router-link>

      <div
        class="d-flex flex-column flex-fill justify-content-start justify-content-sm-between ml-2 ml-sm-3"
      >
        <div class="d-flex justify-content-between">
          ...
          <h4>
            <router-link
              :to="{
                name: 'product.index',
                query: { 'category[]': option.product.category.id },
              }"
        ...
        <div class="d-none d-sm-flex align-items-center">
          <router-link
            v-if="option.default_location"
            :to="{
              name: 'product.show',
              params: { optionId: option.id },
              hash: '#location',
            }"
            class="btn btn-light bg-white p-1 shadow-sm"
          >
