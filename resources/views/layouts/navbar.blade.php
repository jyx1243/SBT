<!-- Navigation Start-->
<nav class="navbar sticky-top navbar-light shadow-sm">
    <div class="container p-0">
        <a class="navbar-brand mb-0 order-1" href="{{ route('index') }}">SBT</a>

        <form method="GET" action="" class="form-inline ml-sm-auto mr-sm-3 mt-1 mt-sm-0 order-3 order-sm-2 col-12 col-sm-auto p-0">
        ...
        <a class="h6 mb-0 text-dark text-decoration-none order-2 order-sm-3" href="">
